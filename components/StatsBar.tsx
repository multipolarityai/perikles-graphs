...
export const StatsBar: React.FC<{ nodes: Node[]; links: Link[] }> = ({ nodes, links }) => {
  ...
  return (
    <div className="pointer-events-none absolute bottom-4 left-1/2 z-40 -translate-x-1/2 rounded-xl border border-white/10 bg-[rgba(20,20,30,0.92)] px-5 py-3 shadow-xl backdrop-blur-md">
